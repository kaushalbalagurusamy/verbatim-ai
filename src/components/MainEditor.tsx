  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="h-9 bg-[#2d2d30] border-b border-[#3c3c3c] flex items-center">
        {tabs.map(tab => (
          <div key={tab.id} className={`flex items-center gap-2 px-3 h-full border-r border-[#3c3c3c] min-w-0 max-w-xs ${tab.active ? 'bg-[#1e1e1e] text-[#ffffff]' : 'bg-[#2d2d30] text-[#cccccc] hover:bg-[#383838]'}`}>
